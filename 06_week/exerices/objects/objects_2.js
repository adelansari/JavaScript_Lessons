...
*/
// Your code here
console.log(`Book 1 title: ${library[0].title}`);
library[1].yearPublished = 2023;
console.log(`Book 2 object: ${JSON.stringify(library[1])}`);
...
*/
// Your code here
library[0].genres = ['Software', 'Design', 'Architecture'];
...
console.log(`New book added to the library: ${JSON.stringify(library[library.length - 1])}`);
...
let newUserBook = createBook('How to Basic', 'Unknown', 2024, ['Funny', 'Destruction']);
console.log(`User book: ${JSON.stringify(newUserBook)}`);
...
console.log(`Library collection in JSON: ${libraryString}`);
let libraryObject = JSON.parse(libraryString);
console.log(`First book title: ${libraryObject[0].title}`);
